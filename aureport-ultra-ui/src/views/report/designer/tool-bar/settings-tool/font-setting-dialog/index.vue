...
function initializeStyle() {
  localStyle.value = {
    ...
    fontSize: props.fontStyle.fontSize === undefined ? '10' : String(props.fontStyle.fontSize),
    bold: props.fontStyle.bold === undefined ? 'false' : String(props.fontStyle.bold),
    italic: props.fontStyle.italic === undefined ? 'false' : String(props.fontStyle.italic),
    underline: props.fontStyle.underline === undefined ? 'false' : String(props.fontStyle.underline),
  }
}
