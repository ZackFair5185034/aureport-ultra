const en = {
  ...
  dialog: {
    ...
    httpDS: {
      title: 'HTTP Datasource Config',
      name: 'Datasource Name',
      protocol: 'Protocol',
      standardProtocol: 'Standard (ReportBean)',
      thirdPartyProtocol: 'Third-party API (HTTP)',
      baseUrl: 'Base URL',
      urlPlaceholder: 'http://host:port/api/report-data',
      hostType: 'Host Mode',
      hostManual: 'Manual',
      hostDiscovery: 'Service Discovery',
      host: 'Host',
      hostTip: 'Host cannot be empty',
      serviceName: 'Service Name',
      serviceNamePlaceholder: 'Nacos registered service name',
      serviceNameTip: 'Service name cannot be empty',
      nameTip: 'Datasource name cannot be null!',
      urlTip: 'Request URL cannot be null',
      standardDatasetDesc: 'Standard protocol datasets need no extra config',
      ...
      ds: 'Datasource',
      exist: ' already exist!',
      datasetConfig: 'HTTP Dataset Config',
      datasetName: 'Dataset Name',
      url: 'Request URL',
      urlParamTip: 'Supports {{paramName}} templates',
      method: 'Method',
      headers: 'Headers',
      headerPlaceholder: 'Key: Value then click Add',
      add: 'Add',
      headersJsonTip: 'Or edit JSON directly',
      body: 'Body',
      bodyPlaceholder: 'Supports {{paramName}} templates',
      responsePath: 'Response JSONPath',
      responsePathPlaceholder: 'e.g. $.data.list, empty for full response',
  ...
  property: {
    ...
    prop: {
      ...
      tooltipExpressionSupport: 'Support expressions, expressions defined in $EXPR...',
      newWindow: 'New Window',
      currentWindow: 'Current Window',
