 ...
 * the License.
 ******************************************************************************/
package com.aureport.ultra.core.export.excel.high.builder;
...
import com.aureport.ultra.core.export.excel.high.CellStyleContext;
        ...
        try {
            ...
            for (Row r : rows) {
                ...
                for (int i = 0; i < columnSize; i++) {
                    ...
                    com.aureport.ultra.core.model.Cell cellInfo = null;
                    if (colCell != null) {
