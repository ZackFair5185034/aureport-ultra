 ...
 * @since 2026-05-17
 */
public class RichTextValueCompute implements ValueCompute {

    @Override
    public List<BindData> compute(Cell cell, Context context) {
        List<BindData> list = new ArrayList<BindData>();
        RichTextValue richTextValue = (RichTextValue) cell.getValue();
        // 直接存储 RichTextValue 对象本身，而不是其 content 字符串
        list.add(new BindData(richTextValue, null, null));
        return list;
    }
