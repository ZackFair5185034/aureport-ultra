 ...
 * the License.
 ******************************************************************************/
package com.aureport.ultra.core.export.word.high;
...
import com.aureport.ultra.core.export.word.DxaUtils;
...
public class WordProducer implements Producer {
    public static final String BEAN_ID = "aureport-ultra.wordExporter";
