 ...
 * the License.
 ******************************************************************************/
package com.aureport.ultra.core.export.excel.high;
...
public class CellStyleContext {
    ...
    private BorderStyle getBorderStyle(Border border) {
        if (border.getStyle().equals(com.aureport.ultra.core.definition.BorderStyle.solid)) {
            return BorderStyle.THIN;
        } else if (border.getStyle().equals(com.aureport.ultra.core.definition.BorderStyle.dashed)) {
            return BorderStyle.DASHED;
        } else if (border.getStyle().equals(com.aureport.ultra.core.definition.BorderStyle.doublesolid)) {
