 ...
 * the License.
 ******************************************************************************/
package com.aureport.ultra.core.export.excel.low;
...
public class Excel97Producer {
    ...
    private void doProduce(Report report, OutputStream outputStream, boolean withPaging, boolean withSheet) {
        ...
        try {
            ...
            Map<Row, Map<Column, com.aureport.ultra.core.model.Cell>> cellMap = report.getRowColCellMap();
            ...
            if (withPaging) {
                ...
                for (Page page : pages) {
                    ...
                    for (Row r : rows) {
                        ...
                        Map<Column, com.aureport.ultra.core.model.Cell> colCell = cellMap.get(r);
                        for (int i = 0; i < columnSize; i++) {
                            ...
                            com.aureport.ultra.core.model.Cell cellInfo = colCell.get(col);
                            if (cellInfo == null) {
                                continue;
                            }
